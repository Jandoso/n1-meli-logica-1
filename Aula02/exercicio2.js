...
if (sorteado != palpite1 && sorteado > palpite1){
    const palpite2 = parseInt(prompt('O número sorteado é maior do que o seu primeiro palpite! Quer tentar outra vez? Qual é o seu segundo palpite?: ')) 
        if (palpite2 == sorteado) {
            alert('Acertou miserávi!')
        } else {
            alert('Não foi dessa vez!')
        }
} else if (sorteado != palpite1 && sorteado < palpite1){
    const palpite2 = parseInt(prompt('O número sorteado é menor do que o seu primeiro palpite! Quer tentar outra vez? Qual é o seu segundo palpite?: '))
        if (palpite2 == sorteado) {
            alert('Acertou miserávi!')
        } else {
            alert('Não foi dessa vez!')
    ...
    console.log('Acertou de primeira miseráve! Parabéns!')
}

//1.2. Faça o mesmo programa anterior, agora com 3 palpites.
const sorteado = Math.floor((Math.random()*10)+1);
const palpite1 = parseInt(prompt('Sorteamos um número de 1 a 10! Vamos ver se você consegue acertar! Digite seu primeiro palpite: '))
const palpite2 = parseInt(prompt('Qual é o seu segundo palpite?: '))
const palpite3 = parseInt(prompt('E que tal mais um palpite?: '))
 
if (sorteado > palpite1){
    console.log('O número sorteado é maior do que o seu primeiro palpite!')
} else if (sorteado < palpite1){
    console.log('O número sorteado é menor do que o seu primeiro palpite')
} else {
    console.log('O número sorteado é igual ao seu primeiro palpite! Parabéns!')
}
